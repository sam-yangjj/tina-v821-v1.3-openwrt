...
define KernelPackage/sensor-sc530ai
	SUBMENU:=$(VIDEO_MENU)
	TITLE:=Sensor sc530ai support (staging)
	DEPENDS:= +kmod-vin-v4l2
	FILES+=$(CONFIG_EXTERNAL_KERNEL_TREE)/bsp/drivers/vin/modules/sensor/sc530ai_mipi.ko
	AUTOLOAD:=$(call AutoProbe,sc530ai_mipi)
endef

define KernelPackage/sensor-sc530ai/description
	Kernel modules for sensor-sc530ai support
endef

$(eval $(call KernelPackage,sensor-sc530ai))
