...
define KernelPackage/sunxi-uvc-host
  SUBMENU:=$(USB_MENU)
  TITLE:=sunxi uvc host support (staging)
  DEPENDS:=+kmod-vin-v4l2
  KCONFIG:=

  FILES+=$(CONFIG_EXTERNAL_KERNEL_TREE)/drivers/media/common/videobuf2/videobuf2-vmalloc.ko
  FILES+=$(CONFIG_EXTERNAL_KERNEL_TREE)/drivers/media/usb/uvc/uvcvideo.ko
  AUTOLOAD:=$(call AutoProbe, uvcvideo.ko)
endef

define KernelPackage/sunxi-uvc-host/description
 Kernel modules for v821 sunxi-uvc-host support: device is used as usb-host to use uvc-camera.
endef

$(eval $(call KernelPackage,sunxi-uvc-host))
