...
typedef struct {
    ...
    */
    INT_T (*get_max_frame_size)(INT_T device, INT_T channel, IPC_STREAM_E stream);
 ...
 */
INT_T tuya_ipc_media_adapter_get_max_frame(INT_T device, INT_T channel, IPC_STREAM_E stream);
