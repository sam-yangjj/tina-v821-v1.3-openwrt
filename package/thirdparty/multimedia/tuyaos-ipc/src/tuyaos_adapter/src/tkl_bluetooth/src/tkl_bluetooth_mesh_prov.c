 ...
 *          ERROR
 * */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_provisioner_init(void)
{
 ...
 *          ERROR
 * */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_stack_reset(UCHAR_T config_reset)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 *          ERROR
 * */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_callback_register(CONST TKL_MESH_EVT_FUNC_CB mesh_evt)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 *          ERROR
 * */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_info_set(TKL_MESH_LOCAL_INFO_T local_info)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_prov_scan(UCHAR_T enable, UINT_T timeout)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 *          ERROR
 * */ 
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_adv_provision_invite(TKL_MESH_DEVICE_INFO_T device)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 *          ERROR
 * */ 
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_node_devkey_add(USHORT_T device_addr, UCHAR_T devkey[16])
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 *          ERROR
 * */ 
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_node_devkey_delete(USHORT_T device_addr, UCHAR_T devkey[16])
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 *          ERROR: failure
 */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_device_get_seq(UINT_T *seq, UINT_T *iv)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 *          ERROR: failure
 */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_device_set_seq(UINT_T seq)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 *          ERROR: failure
 */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_device_update_iv_info(UINT_T iv_index, UCHAR_T flags)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_local_node_set_ttl(UCHAR_T ttl)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 *@return   0: success, negetive value: failure
 */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_local_network_transmit_set(UCHAR_T count, UCHAR_T interval_steps)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 *          ERROR
 * */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_model_message_send(TKL_MESH_DEVICE_INFO_T device, TKL_MESH_DATA_T *p_data)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 *          addresses.
 * */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_config_message_send(TKL_MESH_DEVICE_INFO_T device, TKL_MESH_DATA_T *p_data)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
 ...
 *          ERROR
 * */
TUYA_WEAK_ATTRIBUTE OPERATE_RET tkl_ble_mesh_beacon_message_send(TKL_MESH_DEVICE_INFO_T device, TKL_MESH_DATA_T *p_data)
{
    // --- BEGIN: user implements ---
    return OPRT_NOT_SUPPORTED;
    // --- END: user implements ---
