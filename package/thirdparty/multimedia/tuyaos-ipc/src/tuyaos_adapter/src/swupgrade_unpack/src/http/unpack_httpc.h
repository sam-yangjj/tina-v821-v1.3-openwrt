...
#ifndef _UNPACK_HTTPC_H_
#define _UNPACK_HTTPC_H_
#include <stdio.h>
...
enum wm_httpc_errno {
    ...
    WM_E_HTTPC_SOCKET_TIME,
};


/* Status codes */
#define HTTP_RESP_FORMATIONAL(x) (x >=100 && < 200)
 ...
 * @return -WM_E_VAL if any of the arguments were invalid
 ...
 * @return -WM_E_VAL for an invalid arguments.
 */
 ...
 * @return -WM_E_VAL is returned in case of invalid parameters.
