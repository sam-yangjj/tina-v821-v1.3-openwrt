...
#define TUYA_DP_AWAKE_STATUS               149         /* Doorbell status notification, BOOL type, true means open, false means closed  */
...
// #define TUYA_DP_MOVE_POINT                241
// #define TUYA_DP_MOVE_PATH                 239

#define TUYA_DP_DEVICE_VOLUME             160
// #define TUYA_DP_IPC_CONTRAST                  192
// #define TUYA_DP_IPC_BRIGHT                    193
#define TUYA_DP_IPC_REBOOT                    162
#define TUYA_DP_SHOW_MAC                      11
#define TUYA_DP_FLICKER                       188

#define TUYA_DP_BAT_REPORT_CAP                126

#define TUYA_DP_SIREN_SWITCH                  159
#define TUYA_DP_IPC_BIRD_DETECT_MODE          239

#define TUYA_DP_BIRD_SWITCH                   243
#define TUYA_DP_SIREN_SQUIRREL                244
// 事件提前结束开关(245)
#define TUYA_DP_PIR_ALARM_INTERVAL            246
#define TUYA_DP_IPC_RECORDING_TIME            247
...
typedef enum {
    led_power_on, // 红灯长亮：设备上电开机
    led_wifi_ap,  // 红灯慢闪：进入配网状态
    led_connect,  // 红灯快闪：快速联网中
    led_offline,  // 绿灯慢闪：设备离线或wifi密码错误联网失败
    led_online,   // 绿灯常亮：联网成功
    led_upgrade,  // 红绿闪烁：升级中
    led_keep_off, // 红绿全灭：用户关闭
    led_test,     // 红绿闪烁：产测工具测试,红灯交替闪烁
}led_status_t;
