...
void peer_connection_media_pause(PeerConnection* pc)
{
  pc->media_state = MEDIA_PAUSE;
}

void peer_connection_media_play(PeerConnection* pc)
{
  pc->media_state = MEDIA_PLAYING;
}
