...
static int awISPSetAeTarget(int isp_id, void *target_val)
{
	return isp_set_attr_cfg(isp_id, ISP_CTRL_SET_AE_TARGER, target_val);
}

static int awISPSetAeWeight(int isp_id, void *msg)
{
	return isp_set_attr_cfg(isp_id, ISP_CTRL_SET_AE_WEIGHT, msg);
}
...
AWIspApi *CreateAWIspApi(void)
{
    ...
    ispport->ispSetAeTarget = awISPSetAeTarget;
    ispport->ispSetAeWeight = awISPSetAeWeight;
