...
HW_S32 ini_tuning_set_cfg(HW_U8 group_id, HW_U32 cfg_ids, void *cfg_data)
{
	...
	if (!rdval) {
		...
		if ((group_id == HW_ISP_CFG_TEST) && (cfg_ids & HW_ISP_CFG_TEST_SPECIAL_CTRL)) {
			struct isp_test_special_ctrl_cfg *isp_test_ctrl = (struct isp_test_special_ctrl_cfg *)cfg_data;
			sprintf(isp_cfg_path, "echo %d > %sisp%d_%d_%d_%d_%d/ir", isp_test_ctrl->ir_mode, ini_cfg.base_path, ini_cfg.sensor_cfg.isp, ini_cfg.sensor_cfg.width, ini_cfg.sensor_cfg.height,
					ini_cfg.sensor_cfg.fps, ini_cfg.sensor_cfg.wdr);
			system(isp_cfg_path);

			sprintf(isp_cfg_path, "echo %d > %sisp%d_%d_%d_%d_%d/colorspace", isp_test_ctrl->color_space, ini_cfg.base_path, ini_cfg.sensor_cfg.isp, ini_cfg.sensor_cfg.width, ini_cfg.sensor_cfg.height,
					ini_cfg.sensor_cfg.fps, ini_cfg.sensor_cfg.wdr);
			system(isp_cfg_path);
		}
	}
...
HW_S32 ini_tuning_update_cfg(void)
{
	...
	struct ToolsIniTuning_cfg ini_cfg = GetIniTuningEn();
	sprintf(isp_cfg_path, "echo 0 > %sisp_tuning_isp%d", ini_cfg.base_path, ini_cfg.sensor_cfg.isp);
...
HW_S32 ini_tuning_get_frame(capture_format *cap_fmt, sock_packet *comm_packet, int sock_fd)
{
	...
	int i, ret, cnt = 0, pic_size = 0, size_act = 0, width_act = 0, height_act = 0, format_act = 0, define_path;
	FILE *fd = NULL;
...
HW_S32 ini_tuning_get_encpp_frame(capture_format *cap_fmt, sock_packet *comm_packet, int sock_fd)
{
	...
	sprintf(isp_cfg_path, "%sisp%d_%d_%d_%d_%d/encpp/encpp_width", ini_cfg.base_path, ini_cfg.sensor_cfg.isp, ini_cfg.sensor_cfg.width, ini_cfg.sensor_cfg.height,
					ini_cfg.sensor_cfg.fps, ini_cfg.sensor_cfg.wdr);
	if (access(isp_cfg_path, F_OK) != 0) {
		sprintf(isp_cfg_path, "touch %sisp%d_%d_%d_%d_%d/encpp/encpp_width", ini_cfg.base_path, ini_cfg.sensor_cfg.isp, ini_cfg.sensor_cfg.width, ini_cfg.sensor_cfg.height,
					ini_cfg.sensor_cfg.fps, ini_cfg.sensor_cfg.wdr);
		system(isp_cfg_path);
	}
	sprintf(isp_cfg_path, "echo %d > %sisp%d_%d_%d_%d_%d/encpp/encpp_width", cap_fmt->width, ini_cfg.base_path, ini_cfg.sensor_cfg.isp, ini_cfg.sensor_cfg.width, ini_cfg.sensor_cfg.height,
					ini_cfg.sensor_cfg.fps, ini_cfg.sensor_cfg.wdr);
	system(isp_cfg_path);
	...
	sprintf(isp_cfg_path, "%sisp%d_%d_%d_%d_%d/encpp/encpp_height", ini_cfg.base_path, ini_cfg.sensor_cfg.isp, ini_cfg.sensor_cfg.width, ini_cfg.sensor_cfg.height,
					ini_cfg.sensor_cfg.fps, ini_cfg.sensor_cfg.wdr);
	if (access(isp_cfg_path, F_OK) != 0) {
		sprintf(isp_cfg_path, "touch %sisp%d_%d_%d_%d_%d/encpp/encpp_height", ini_cfg.base_path, ini_cfg.sensor_cfg.isp, ini_cfg.sensor_cfg.width, ini_cfg.sensor_cfg.height,
					ini_cfg.sensor_cfg.fps, ini_cfg.sensor_cfg.wdr);
		system(isp_cfg_path);
	}
	sprintf(isp_cfg_path, "echo %d > %sisp%d_%d_%d_%d_%d/encpp/encpp_height", cap_fmt->height, ini_cfg.base_path, ini_cfg.sensor_cfg.isp, ini_cfg.sensor_cfg.width, ini_cfg.sensor_cfg.height,
					ini_cfg.sensor_cfg.fps, ini_cfg.sensor_cfg.wdr);
	system(isp_cfg_path);
...
re_try:
		...
		if (!rdval) {
			...
			sprintf(isp_cfg_path, "echo 0 > %sisp%d_%d_%d_%d_%d/LOG/flag", ini_cfg.base_path, ini_cfg.sensor_cfg.isp, ini_cfg.sensor_cfg.width, ini_cfg.sensor_cfg.height,
					ini_cfg.sensor_cfg.fps, ini_cfg.sensor_cfg.wdr);
			system(isp_cfg_path);
		}
	}
