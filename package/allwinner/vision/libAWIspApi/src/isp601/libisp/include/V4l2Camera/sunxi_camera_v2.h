...
struct get_rv_yuv_cfg {
	int request_frame_num;
	int return_frame_num;
	void *vir_addr;
	unsigned int size;
	int is_scan_stop;
...
#define VIDIOC_SET_RV_YUV_MMAP_CFG \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 29, struct rv_yuv_mmap_cfg)
#define VIDIOC_GET_RV_YUV_CFG \
	_IOWR('V', BASE_VIDIOC_PRIVATE + 30, struct get_rv_yuv_cfg)
